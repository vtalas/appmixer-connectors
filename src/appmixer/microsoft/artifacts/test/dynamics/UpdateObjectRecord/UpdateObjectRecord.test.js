...
const action = require('../../../../dynamics/UpdateObjectRecord/UpdateObjectRecord');

describe('UpdateObjectRecord', function() {
        ...
        describe('receive - update', function() {
            ...
            it('should call httpRequest with correct options', async function() {
                ...
                context.messages = {
                    in: {
                        content: {
                            id: leadResponseStub.data.leadid,
                            objectName: 'lead',
                ...
                assert.equal(context.httpRequest.args[0][0].method, 'PATCH', 'should call httpRequest with correct method');
                assert.equal(context.httpRequest.args[0][0].url, `${context.resource}/api/data/v9.2/leads(${leadResponseStub.data.leadid})`, 'should call httpRequest with correct url');

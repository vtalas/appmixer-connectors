...
const action = require('../../../sharepoint/FindFilesOrFolders/FindFilesOrFolders.js');
let runTests;


// all tests assume nobody did anything inside the MochaTestLib like adding/deleting file etc
describe('Search files in root', function() {
    let context;
...
describe('Search files with parent path', function() {
    let context;
    const parentPaths = {

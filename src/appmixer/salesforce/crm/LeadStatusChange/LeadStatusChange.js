...
const OUTPUT_PORT = 'lead';

/**
 * Trigger that fires with the lead details whenever the monitored field
 * (the Lead Status by default) changes value.
 * @extends {Component}
 */
module.exports = {
    ...
    async test(context) {
        ...
        if (!record) {
            throw new Error('No Lead record available to use as test data.');
        }

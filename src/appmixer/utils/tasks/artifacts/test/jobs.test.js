...
describe('utils-tasks-jobs', () => {
    ...
    beforeEach(async () => {
        ...
        const taskModelPath = path.resolve(__dirname, '../../TaskModel.js');
        let records = [];
        let savedModels = [];
        class FakeTask {
        ...
        const webhookModelPath = path.resolve(__dirname, '../../WebhookModel.js');
        ...
        const jobsPath = path.resolve(__dirname, '../../jobs.js');

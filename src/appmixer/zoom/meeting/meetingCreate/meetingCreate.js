...
module.exports = {
    ...
    httpRequest: async function(context) {
        ...
        const inputMapping = {
            ...
            'topic': input['topic'],
            'tracking_fields': !!input['tracking_fields'] ? JSON.parse(input['tracking_fields']) : undefined,
            'type': input['type'],
            ...
            'settings.additional_data_center_regions': !!input['settings|additional_data_center_regions'] ? JSON.parse(input['settings|additional_data_center_regions']) : undefined,
            ...
            'settings.approved_or_denied_countries_or_regions': !!input['settings|approved_or_denied_countries_or_regions'] ? JSON.parse(input['settings|approved_or_denied_countries_or_regions']) : undefined,
            'settings.audio': input['settings|audio'],
            'settings.authentication_domains': input['settings|authentication_domains'],
            'settings.authentication_exception': !!input['settings|authentication_exception'] ? JSON.parse(input['settings|authentication_exception']) : undefined,
            'settings.authentication_option': input['settings|authentication_option'],
            'settings.auto_recording': input['settings|auto_recording'],
            'settings.breakout_room': !!input['settings|breakout_room'] ? JSON.parse(input['settings|breakout_room']) : undefined,
            ...
            'settings.global_dial_in_countries': !!input['settings|global_dial_in_countries'] ? JSON.parse(input['settings|global_dial_in_countries']) : undefined,
            ...
            'settings.language_interpretation': !!input['settings|language_interpretation'] ? JSON.parse(input['settings|language_interpretation']) : undefined,
            'settings.meeting_authentication': input['settings|meeting_authentication'],
            'settings.meeting_invitees': !!input['settings|meeting_invitees'] ? JSON.parse(input['settings|meeting_invitees']) : undefined,
